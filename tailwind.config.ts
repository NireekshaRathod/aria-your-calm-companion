  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        aria: {
          pink: "hsl(var(--aria-pink))",
          lavender: "hsl(var(--aria-lavender))",
          purple: "hsl(var(--aria-purple))",
          blue: "hsl(var(--aria-soft-blue))",
          peach: "hsl(var(--aria-peach))",
          mint: "hsl(var(--aria-mint))",
        },
        sidebar: {
      ...
      animation: {
        ...
        "snow-fall": "snow-fall 2s ease-out forwards",
